...
public class SocketServer implements Runnable {
    ...
    public SocketServer(ServerFrame frame) {
        ...
        try {
            ...
            ui.jTextArea1.append("Servidor iniciado. IP : " + InetAddress.getLocalHost() + ", Puerto : " + server.getLocalPort());
            start();
        } catch (IOException ioe) {
            ui.jTextArea1.append("No se puede conectar con el puerto : " + port + "\nReintentando");
            ui.RetryStart(0);
        }
    }
    ...
    public SocketServer(ServerFrame frame, int Port) {
        ...
        try {
            ...
            ui.jTextArea1.append("\nNo se puede conectar con el puerto " + port + ": " + ioe.getMessage());
        }
    }
    ...
    public void run() {
        while (thread != null) {
            try {
                ...
                ui.jTextArea1.append("\nError de aceptación del servidor: \n");
                ui.RetryStart(0);
            }
        }
    }
    ...
    public synchronized void handle(int ID, Message msg) {
        if (msg.content.equals(".bye")) {
            ...
            if (msg.type.equals("login")) {
                ...
                if (msg.recipient.equals("All")) {
                    clients[findClient(ID)].send(new Message("message", "SERVER", "Prohibido subir a todos", msg.sender));
                } else {
    ...
    public synchronized void remove(int ID) {
        ...
        if (pos >= 0) {
            ...
            ui.jTextArea1.append("\nEliminando hilo del cliente... " + ID + " at " + pos);
    ...
    private void addThread(Socket socket) {
        if (clientCount < clients.length) {
            ...
            try {
                ...
                ui.jTextArea1.append("\nError al abrir hilo: " + ioe);
            }
        } else {
            ui.jTextArea1.append("\nCliente rechazado:Máximo " + clients.length + " alcanzados.");
        }
    }
}
